    ...
    <section className="py-24 md:py-32 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <motion.div
          ...
          className="group relative overflow-hidden rounded-[3rem] border border-white/10 bg-white/5 backdrop-blur-2xl p-10 md:p-16 lg:p-24 text-center transition-all duration-500 hover:border-indigo-500/30 hover:shadow-[0_0_50px_rgba(79,70,229,0.15)]"
        >
          ...
          <motion.p
            ...
            className="mb-10 md:mb-12 text-base sm:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed"
          >
